...
## Corpus Check
- 281 files · ~544,319 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2572 nodes · 6238 edges · 56 communities detected
- Extraction: 55% EXTRACTED · 45% INFERRED · 0% AMBIGUOUS · INFERRED: 2791 edges (avg confidence: 0.74)
...
Cohesion: 0.02
Nodes (199): admin_deleteuser_handler(), delete_user_command(), _clear_voice_mode(), command_language_callback_handler(), command_language_keyboard(), command_level_callback_handler(), command_level_keyboard(), help_command_handler() (+191 more)

### Community 1 - "Community 1"
Cohesion: 0.02
Nodes (210): build_graph(), Graph, _cross_community_surprises(), _cross_file_surprises(), _file_category(), god_nodes(), graph_diff(), _is_concept_node() (+202 more)

### Community 2 - "Community 2"
Cohesion: 0.02
Nodes (213): _check_tree_sitter_version(), _csharp_extra_walk(), extract(), extract_blade(), extract_c(), extract_cpp(), extract_csharp(), extract_dart() (+205 more)
...
Cohesion: 0.03
Nodes (80): add(), _community_article(), _cross_community_links(), _god_node_article(), _index_md(), Return (community_label, edge_count) pairs for cross-community connections, sort, admin_stats_handler(), CourseLesson (+72 more)

### Community 5 - "Community 5"
Cohesion: 0.03
Nodes (42): Base, MyApp.Accounts.User, create(), validate(), Server, handle_course_promo_start(), handle_image_message(), handle_voice_message() (+34 more)
...
Cohesion: 0.04
Nodes (100): find(), collect_files(), extract_python(), Extract classes, functions, and imports from a .py file via tree-sitter AST., _prepare_title_i18n(), _status_label(), course_homework_keyboard(), course_reminder_notification_keyboard() (+92 more)
...
Cohesion: 0.03
Nodes (41): _background_scheduler(), lifespan(), Run all lesson seed scripts in the background after startup., Run all lesson seed scripts in the background after startup., Run all lesson seed scripts in the background after startup., _seed_lessons(), BaseMiddleware, create_bot() (+33 more)

### Community 10 - "Community 10"
Cohesion: 0.04
Nodes (62): Base, DeclarativeBase, AdminAudioStates, admin_audio_list_handler(), admin_broadcast_handler(), admin_broadcast_info(), admin_deleteuser_info(), admin_giveaccess_handler() (+54 more)

### Community 11 - "Community 11"
Cohesion: 0.06
Nodes (63): admin_discount_panel(), _admin_ids(), _delete_admin_input(), discount_cancel(), discount_confirm(), discount_custom_duration(), discount_disable(), discount_duration() (+55 more)
...
Cohesion: 0.08
Nodes (46): Return the first path component - used to detect cross-repo edges., Score how surprising a cross-file edge is. Returns (score, reasons)., _surprise_score(), _top_level_dir(), Generate a Wikipedia-style wiki from the graph.      Writes:       - index.md, _safe_filename(), to_wiki(), Code↔paper edge should score higher than code↔code edge. (+38 more)
...
Cohesion: 0.14
Nodes (13): area(), Circle, Color, describe(), Geometry, main(), multiply(), NewServer() (+5 more)
...
## Knowledge Gaps
- **401 isolated node(s):** `AI tutor javobidan keyin: 'Tushundim' → keyingi bo'limga o'tish.`, `Shown while waiting for 3 referrals — only back button.`, `Shown when 3/3 referrals reached — plan buttons + back.`, `lesson.title oddiy string yoki JSON bo'lishi mumkin — xitoycha qismini qaytaradi`, `V2 darslar uchun universal 'Davom etamiz' tugmasi (audiosiz).` (+396 more)
...
- **Thin community `Community 50`** (3 nodes): `__init__.py`, `__getattr__()`, `graphify - extract · build · cluster · analyze · report.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 65`** (1 nodes): `lesson.title oddiy string yoki JSON bo'lishi mumkin — xitoycha qismini qaytaradi`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 66`** (1 nodes): `V2 darslar uchun universal 'Davom etamiz' tugmasi (audiosiz).`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 67`** (1 nodes): `V2 vocab_1 / vocab_2 step: [🔉]  [▶️ Davom etamiz].`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 68`** (1 nodes): `V2 dialogue_N step: [🔉]  [▶️ Davom etamiz].`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 69`** (1 nodes): `Keyingi o'qish vaqtini tanlash — inline tugmalar (ReplyKeyboard o'rniga).`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.

## Suggested Questions
_Questions this graph is uniquely positioned to answer:_

- **Why does `add()` connect `Community 4` to `Community 0`, `Community 1`, `Community 2`, `Community 5`, `Community 7`, `Community 9`, `Community 10`, `Community 11`, `Community 12`, `Community 13`, `Community 14`, `Community 17`, `Community 18`, `Community 23`, `Community 24`?**
  _High betweenness centrality (0.097) - this node is a cross-community bridge._
- **Why does `t()` connect `Community 0` to `Community 5`, `Community 7`, `Community 9`, `Community 10`, `Community 11`, `Community 18`?**
  _High betweenness centrality (0.063) - this node is a cross-community bridge._
- **Why does `UserRepository` connect `Community 0` to `Community 5`, `Community 9`, `Community 10`, `Community 11`, `Community 18`, `Community 22`?**
  _High betweenness centrality (0.050) - this node is a cross-community bridge._
- **Are the 120 inferred relationships involving `UserRepository` (e.g. with `User` and `Message`) actually correct?**
  _`UserRepository` has 120 INFERRED edges - model-reasoned connections that need verification._
...
- **Are the 85 inferred relationships involving `add()` (e.g. with `.create()` and `.create()`) actually correct?**
  _`add()` has 85 INFERRED edges - model-reasoned connections that need verification._