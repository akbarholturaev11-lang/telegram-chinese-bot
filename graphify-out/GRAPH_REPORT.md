...
## Corpus Check
- 269 files · ~533,082 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2378 nodes · 5507 edges · 45 communities detected
- Extraction: 56% EXTRACTED · 44% INFERRED · 0% AMBIGUOUS · INFERRED: 2404 edges (avg confidence: 0.75)
...
Cohesion: 0.02
Nodes (162): create(), OnboardingStates, admin_deleteuser_handler(), delete_user_command(), command_language_callback_handler(), command_language_keyboard(), command_level_callback_handler(), command_level_keyboard() (+154 more)
...
Cohesion: 0.02
Nodes (102): Base, Base, DeclarativeBase, add(), _community_article(), _cross_community_links(), _god_node_article(), _index_md() (+94 more)
...
Cohesion: 0.03
Nodes (150): build_graph(), Graph, _cross_community_surprises(), _cross_file_surprises(), _file_category(), god_nodes(), graph_diff(), _is_concept_node() (+142 more)

### Community 7 - "Community 7"
Cohesion: 0.03
Nodes (26): admin_payment_approve_handler(), admin_payment_reject_handler(), admin_payment_reject_reason_select_handler(), admin_payment_reject_with_reason_handler(), handle_image_message(), _is_night(), payment_screenshot_handler(), _waiting_message() (+18 more)
...
Cohesion: 0.04
Nodes (92): _load_graphifyignore(), Read .graphifyignore from root **and ancestor directories**.      Returns a list, collect_files(), extract_python(), Extract classes, functions, and imports from a .py file via tree-sitter AST., _status_label(), course_homework_keyboard(), course_reminder_notification_keyboard() (+84 more)
...
Cohesion: 0.08
Nodes (37): AdminAudioStates, BroadcastStates, DiscountStates, admin_audio_entry(), admin_audio_from_panel(), _after_upload_keyboard(), ask_for_audio_file(), audio_stats() (+29 more)
...
## Knowledge Gaps
- **390 isolated node(s):** `AI tutor javobidan keyin: 'Tushundim' → keyingi bo'limga o'tish.`, `Shown while waiting for 3 referrals — only back button.`, `Shown when 3/3 referrals reached — plan buttons + back.`, `lesson.title oddiy string yoki JSON bo'lishi mumkin — xitoycha qismini qaytaradi`, `V2 darslar uchun universal 'Davom etamiz' tugmasi (audiosiz).` (+385 more)
...
- **Thin community `Community 35`** (4 nodes): `0003_add_referrals_and_user_discount_fields.py`, `downgrade()`, `add referrals and user discount fields  Revision ID: 0003 Revises: 0002 Create D`, `upgrade()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 36`** (4 nodes): `0019_add_discount_campaign_title_i18n.py`, `downgrade()`, `add discount campaign title i18n  Revision ID: 0019_add_discount_campaign_title_`, `upgrade()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Why does `add()` connect `Community 2` to `Community 0`, `Community 1`, `Community 4`, `Community 6`, `Community 7`, `Community 9`, `Community 10`, `Community 11`, `Community 12`, `Community 13`, `Community 18`?**
  _High betweenness centrality (0.092) - this node is a cross-community bridge._
- **Why does `_extract_generic()` connect `Community 1` to `Community 9`, `Community 2`, `Community 4`, `Community 6`?**
  _High betweenness centrality (0.057) - this node is a cross-community bridge._
- **Why does `UserRepository` connect `Community 0` to `Community 2`, `Community 7`, `Community 10`, `Community 14`, `Community 17`?**
...
- **Are the 107 inferred relationships involving `str` (e.g. with `_ensure_bootstrap_columns()` and `discount_title_for_lang()`) actually correct?**
...
- **Are the 79 inferred relationships involving `t()` (e.g. with `course_review_offer_keyboard()` and `course_satisfaction_keyboard()`) actually correct?**
