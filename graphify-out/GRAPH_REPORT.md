...
## Corpus Check
- 277 files · ~537,138 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2458 nodes · 5761 edges · 48 communities detected
- Extraction: 56% EXTRACTED · 44% INFERRED · 0% AMBIGUOUS · INFERRED: 2535 edges (avg confidence: 0.75)
...
Cohesion: 0.02
Nodes (199): create(), admin_deleteuser_handler(), admin_payment_approve_handler(), admin_payment_reject_handler(), admin_payment_reject_with_reason_handler(), command_language_callback_handler(), command_language_keyboard(), command_level_callback_handler() (+191 more)
...
Cohesion: 0.02
Nodes (167): MyApp.Accounts.User, find(), validate(), _cross_community_surprises(), _cross_file_surprises(), _file_category(), god_nodes(), graph_diff() (+159 more)

### Community 3 - "Community 3"
Cohesion: 0.02
Nodes (122): add(), build_graph(), Graph, build_from_json(), Build a NetworkX graph from an extraction dict.      directed=True produces a Di, attach_hyperedges(), Store hyperedges in the graph's metadata dict., to_json() (+114 more)
...
Cohesion: 0.04
Nodes (59): Base, Base, DeclarativeBase, AdminAudioStates, admin_audio_list_handler(), admin_broadcast_handler(), admin_broadcast_info(), admin_deleteuser_info() (+51 more)

### Community 9 - "Community 9"
Cohesion: 0.07
Nodes (61): admin_discount_panel(), _admin_ids(), _delete_admin_input(), discount_cancel(), discount_confirm(), discount_custom_duration(), discount_disable(), discount_duration() (+53 more)
...
Cohesion: 0.05
Nodes (54): area(), Analyzer, compute_score(), normalize(), Fixture: functions and methods that call each other - for call-graph extraction, run_analysis(), Circle, Color (+46 more)
...
Cohesion: 0.08
Nodes (18): admin_payment_reject_reason_select_handler(), _edit_message(), _edit_stored_message(), feedback_callback_handler(), feedback_other_text_handler(), _load_feedback_context(), _parse_feedback_callback(), admin_payment_review_keyboard() (+10 more)
...
- **Why does `add()` connect `Community 3` to `Community 0`, `Community 1`, `Community 2`, `Community 8`, `Community 9`, `Community 10`, `Community 11`, `Community 12`, `Community 13`, `Community 15`, `Community 22`, `Community 23`?**
  _High betweenness centrality (0.066) - this node is a cross-community bridge._
- **Why does `t()` connect `Community 0` to `Community 2`, `Community 6`, `Community 9`, `Community 15`, `Community 17`?**
  _High betweenness centrality (0.062) - this node is a cross-community bridge._
- **Why does `UserRepository` connect `Community 0` to `Community 6`, `Community 8`, `Community 9`, `Community 15`, `Community 17`, `Community 21`?**
