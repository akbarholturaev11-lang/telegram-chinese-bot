...
## Corpus Check
- 295 files · ~548,838 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2646 nodes · 6469 edges · 55 communities detected
- Extraction: 55% EXTRACTED · 45% INFERRED · 0% AMBIGUOUS · INFERRED: 2912 edges (avg confidence: 0.74)
...
- `_store_voice_transcript()` --calls--> `create()`  [INFERRED]
...
Cohesion: 0.02
Nodes (248): build_graph(), Graph, _cross_community_surprises(), _cross_file_surprises(), _file_category(), god_nodes(), graph_diff(), _is_concept_node() (+240 more)

### Community 1 - "Community 1"
Cohesion: 0.02
Nodes (169): admin_deleteuser_handler(), delete_user_command(), _clear_voice_mode(), command_language_callback_handler(), command_language_keyboard(), command_level_callback_handler(), command_level_keyboard(), help_command_handler() (+161 more)

### Community 2 - "Community 2"
Cohesion: 0.02
Nodes (125): add(), _load_tsconfig_aliases(), Walk up from start_dir to find tsconfig.json and return compilerOptions.paths al, admin_audio_list_handler(), admin_broadcast_handler(), admin_broadcast_info(), admin_deleteuser_info(), admin_giveaccess_handler() (+117 more)
...
Cohesion: 0.03
Nodes (103): MyApp.Accounts.User, create(), find(), validate(), OnboardingStates, _prepare_title_i18n(), profile_menu_course(), _status_label() (+95 more)

### Community 7 - "Community 7"
Cohesion: 0.04
Nodes (47): area(), Circle, Color, describe(), Geometry, main(), multiply(), NewServer() (+39 more)

### Community 8 - "Community 8"
Cohesion: 0.04
Nodes (33): admin_payment_approve_handler(), admin_payment_reject_handler(), admin_payment_reject_reason_select_handler(), admin_payment_reject_with_reason_handler(), _edit_message(), _edit_stored_message(), feedback_callback_handler(), feedback_other_text_handler() (+25 more)
...
Cohesion: 0.05
Nodes (61): Base, Base, DeclarativeBase, AdminAudioStates, BroadcastStates, DiscountStates, AdminPortfolioStates, FeedbackStates (+53 more)
...
Cohesion: 0.06
Nodes (21): _background_scheduler(), lifespan(), Run all lesson seed scripts in the background after startup., Run all lesson seed scripts in the background after startup., Run all lesson seed scripts in the background after startup., _seed_lessons(), BaseMiddleware, create_bot() (+13 more)
...
Cohesion: 0.08
Nodes (40): collect_files(), extract_python(), Extract classes, functions, and imports from a .py file via tree-sitter AST., After merging multiple files, no internal edges should be dangling., Call-graph pass must produce INFERRED calls edges., AST-resolved call edges are deterministic and should be EXTRACTED/1.0., Same input always produces same output., run_analysis() calls compute_score() - must appear as a calls edge. (+32 more)
...
- **Thin community `Community 49`** (3 nodes): `__init__.py`, `__getattr__()`, `graphify - extract · build · cluster · analyze · report.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 73`** (1 nodes): `lesson.title oddiy string yoki JSON bo'lishi mumkin — xitoycha qismini qaytaradi`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Why does `UserRepository` connect `Community 1` to `Community 6`, `Community 7`, `Community 8`, `Community 10`, `Community 14`, `Community 16`, `Community 22`?**
  _High betweenness centrality (0.073) - this node is a cross-community bridge._
- **Why does `add()` connect `Community 2` to `Community 0`, `Community 1`, `Community 4`, `Community 6`, `Community 7`, `Community 8`, `Community 10`, `Community 11`, `Community 12`, `Community 13`, `Community 15`, `Community 17`?**
  _High betweenness centrality (0.067) - this node is a cross-community bridge._
- **Why does `_ensure_bootstrap_columns()` connect `Community 16` to `Community 0`, `Community 2`, `Community 19`?**
