...
## Corpus Check
- 291 files · ~546,719 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2592 nodes · 6260 edges · 54 communities detected
- Extraction: 55% EXTRACTED · 45% INFERRED · 0% AMBIGUOUS · INFERRED: 2794 edges (avg confidence: 0.74)
...
Cohesion: 0.02
Nodes (240): build_graph(), Graph, _cross_community_surprises(), _cross_file_surprises(), _file_category(), god_nodes(), graph_diff(), _is_concept_node() (+232 more)

### Community 1 - "Community 1"
Cohesion: 0.02
Nodes (134): Base, admin_deleteuser_handler(), delete_user_command(), admin_payment_approve_handler(), admin_payment_reject_handler(), admin_payment_reject_with_reason_handler(), Yuklangan audio fayllar ro'yxati: /audio_list hsk1 1, Yuklangan audio fayllar ro'yxati: /audio_list hsk1 1 (+126 more)

### Community 2 - "Community 2"
Cohesion: 0.03
Nodes (153): collect_files(), extract_python(), Extract classes, functions, and imports from a .py file via tree-sitter AST., profile_menu_course(), _status_label(), _block_if_course_disabled(), course_audio_dialogue_handler(), course_audio_dialogue_n_handler() (+145 more)
...
Cohesion: 0.02
Nodes (106): add(), admin_stats_handler(), CourseLesson, _cross_community_surprises(), _cross_file_surprises(), _file_category(), god_nodes(), graph_diff() (+98 more)
...
Cohesion: 0.03
Nodes (55): MyApp.Accounts.User, create(), validate(), Server, BroadcastStates, DiscountStates, FeedbackStates, OnboardingStates (+47 more)
...
- **Why does `add()` connect `Community 5` to `Community 0`, `Community 1`, `Community 2`, `Community 3`, `Community 7`, `Community 9`, `Community 11`, `Community 13`, `Community 14`, `Community 16`, `Community 18`, `Community 22`?**
  _High betweenness centrality (0.104) - this node is a cross-community bridge._
- **Why does `_extract_generic()` connect `Community 3` to `Community 0`, `Community 2`, `Community 5`?**
  _High betweenness centrality (0.065) - this node is a cross-community bridge._
- **Why does `t()` connect `Community 1` to `Community 9`, `Community 2`, `Community 12`, `Community 7`?**
...
- **Are the 86 inferred relationships involving `add()` (e.g. with `.create()` and `.create()`) actually correct?**
  _`add()` has 86 INFERRED edges - model-reasoned connections that need verification._